...
<select onchange="myFunction()"  id="mySelect"  class="form-control border-input" >
  ...
  <option value="lit">Literary Events</option>
...
<div class="col-md-8 col-md-offset-2" id = 'lit' style="display: none">
<div class="form-group">
<select id = "litsel"  class="form-control border-input" name="type" >
  <option value="">Select Your Event</option>
  <option value="coc">Cocktail</option>
...
<div class="col-md-6 col-md-offset-3 text-center">
<button onclick="litfn()"  class="btn btn-info btn-fill btn-wd btn_auth">
Submit
</button>
</div>
...
<div class="form-group">
    <div class="col-md-8 col-md-offset-2" >
      ...
      <select onchange="myEvents()"  id="myEven"  class="form-control border-input" >
        <option value="">Select Your Category</option>
        <option value="mtech">Technical Events</option>
        <option value="mcult">Cultural Events</option>
        <option value="mlit">Literary Events</option>
      ...
      <?php
          ...
          foreach ($str_arr as $s) {
            ...
            else if ($s == "Art of Design" || $s =="Band Slam" ||  $s =="Canvas" ||  $s =="Couture" ||  $s =="Exodia Idol" ||   $s == "Doodle" ||  $s =="Game of Streets(Dance Faceoff)" ||  $s =="Groove Fanatics" ||  $s =="Landscape Photography" ||  $s =="Portrait Photography" ||   $s =="Street Soul" || $s == "Synchronians") {
                $cult[] = $s;
            }

            else if ( $s == "Imagination" ||  $s == "Short Movie Making"  ) {
                $onli[] = $s;
            }

            else if ( $s =="Fill with Feel" ||  $s =="React and Act" ||   $s == "Cocktail" ) {
                $lit[] = $s;
            }
          }
      ...
      <div class="col-md-8 col-md-offset-2" id = 'mlit' style="display: none">
        <div class="form-group">
          <?php
                foreach ($lit as $t) {
            ?>
...
<div class="form-group">
    <div class="col-md-8 col-md-offset-2" >
      <div class="form-group">
        <h5>Register for Workshops.</h5>
      <p></p>
      </div>
    </div>

    <div class="col-md-6 col-md-offset-3 text-center">
    <a href = "workshops.php"><button class="btn btn-info btn-fill btn-wd btn_auth">
    Register
    </button></a>
    <br>&nbsp;<br>&nbsp;
</div>
