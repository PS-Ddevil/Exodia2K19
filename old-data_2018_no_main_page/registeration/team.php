...
<div class="col-md-8 col-md-offset-2">
<div class="form-group">
<input id="password" placeholder="Team Members (seperated by ',')" type="text" class="form-control border-input" name="names" value=""  autofocus="">
</div>
</div>
...
<div class="form-group">
    ...
    <?php
        if (isset($_SESSION['name_of_tableww'])) {
            if ( $_SESSION['name_of_tableww'] == 'coc' || $_SESSION['name_of_tableww'] == 'fil' || $_SESSION['name_of_tableww'] == 'rea') {
                ?>

<div class="col-md-8 col-md-offset-2">
<div class="form-group">
<p align="center">There is no fees for Literary Events!<br>You do not pay any fees on the next page! Click <b>"Pay Later"</b> on the next page to go back to events page.</p>
</div>
</div>
    <?php 
        } else {
...
<div class="col-md-8 col-md-offset-2">
<div class="form-group">
<p align="center">Click "Register Team" to complete your registeration!<br>You can complete the payment on the next page!</p>
</div>
</div>
    <?php
        }
