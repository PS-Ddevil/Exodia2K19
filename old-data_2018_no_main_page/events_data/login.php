...
<form class="auth_form" method="POST" action="validate.php">

<div class="row">
<div class="col-md-8 col-md-offset-2">
<div class="form-group">
<input id="email" placeholder="E-mail" class="form-control border-input" name="email" value="" required="" autofocus="">
</div>
</div>
<div class="col-md-8 col-md-offset-2">
<div class="form-group">
