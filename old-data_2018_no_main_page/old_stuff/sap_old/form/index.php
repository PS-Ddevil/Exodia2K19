	...
	<style type="text/css">
		...
		<?php
			if(isset($_POST['submit'])){
				...
				$bio=$_POST['bio'];
				$firsthear=$_POST['firsthear'];
				$help=$_POST['help'];
				$outofbox=$_POST['outofbox'];
				$pullwell=$_POST['pullwell'];
				...
				$sql = "UPDATE answers set personal='$bio', first_hear='$firsthear', develop_individual='$help', new_idea='$outofbox', well_pulled='$pullwell', improvement='$improve', suggestions='$suggestions' where id=$req_id";
