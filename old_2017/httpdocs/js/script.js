! function(a) {
    a.fn.countDown = function(t) {
        ...
        var i = new Date;
        return diffSecs = Math.floor((e.valueOf() - i.valueOf()) / 1e3), a.data(this[0], "diffSecs", diffSecs), diffSecs
    }, a.fn.doCountDown = function(i, o, s) {
        $this = a("#" + i), 0 >= o && (o = 0, a.data($this[0], "timer") && clearTimeout(a.data($this[0], "timer"))), secs = o % 60, mins = Math.floor(o / 60) % 60, hours = Math.floor(o / 60 / 60) % 24, 1 == a.data($this[0], "omitWeeks") ? (days = Math.floor(o / 60 / 60 / 24), weeks = Math.floor(o / 60 / 60 / 24 / 7)) : (days = Math.floor(o / 60 / 60 / 24) % 7, weeks = Math.floor(o / 60 / 60 / 24 / 7)), $this.dashChangeTo(i, "seconds", secs, s ? s : 800), $this.dashChangeTo(i, "minutes", mins, s ? s : 1200), $this.dashChangeTo(i, "hours", hours, s ? s : 1200), $this.dashChangeTo(i, "days", days, s ? s : 1200), $this.dashChangeTo(i, "weeks", weeks, s ? s : 1200), a.data($this[0], "diffSecs", o), o > 0 ? (e = $this, t = setTimeout(function() {
            e.doCountDown(i, o - 1)
        ...
        for (var s = $this.find("." + e + " .digit").length - 1; s >= 0; s--) {
            var n = i % 10;
            i = (i - n) / 10, $this.digitChangeTo("#" + $this.attr("id") + " ." + e + " .digit:eq(" + s + ")", n, o)
        }
    }, a.fn.digitChangeTo = function(t, e, i) {
        i || (i = 800), a(t + " div.top").html() != e + "" && (a(t + " div.top").css({
            display: "none"
        }), a(t + " div.top").html(e ? e : "0").slideDown(i), a(t + " div.bottom").animate({
            height: ""
        }, i, function() {
            a(t + " div.bottom").html(a(t + " div.top").html()), a(t + " div.bottom").css({
                display: "block",
                height: ""
