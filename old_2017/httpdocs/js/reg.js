	...
	$(document).on("click","#subTeam",function(){
		...
		$.ajax({
			...
			if(d==0){
				...
				//$("#log").html(d);
					alert("<span>Team name : " + $("#tname").val() + "<a href='https://www.thecollegefever.com/events/exodia-59cpkdHsPN'>Proceed to payment</a></span>");
					$("#reg_exist").append("<span>Team name : " + $("#tname").val() + "<a href='https://www.thecollegefever.com/events/exodia-59cpkdHsPN'>Proceed to payment</a></span>");
			}
