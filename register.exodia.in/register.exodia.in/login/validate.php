...
try {
    ...
    header("Location: https://register.exodia.in/login/home");
}
catch (\Delight\Auth\InvalidEmailException $e) {
    $info = 'Wrong email address';
}
...
<body class="permission_denied">
    ...
    <div class="denied__wrapper">
      ...
      <a href="https://register.exodia.in/login"><button class="denied__link">Login again</button></a>
    </div>
</body>
</html>